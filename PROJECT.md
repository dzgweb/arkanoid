...
| M4 | Audio Synth, Particles, Screen Shake & FX Polish | Web Audio API procedural synth (12 SFX), 350-particle emitter system, quadratic screen shake, neon visual effects, level transitions & score multiplier | M3 | DONE |
