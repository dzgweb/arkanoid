...
|---|------|-------|-------------|--------|
| M1 | Next.js Project Foundation & React UI Shell | Next.js App Router, Tailwind CSS, TypeScript setup, Canvas container, HUD, Modal overlays, decoupled State Bridge, LocalStorage high scores | none | PLANNED |
